...
- (void)setUpUI {
    ...
    self.containerView.frame = CGRectMake(cvF.origin.x + 30, cvF.origin.y, self.frame.size.width - 45, cvF.size.height);
    ...
    self.messageLabel.frame = CGRectMake(self.messageLabel.frame.origin.x + 45, self.messageLabel.frame.origin.y, self.messageLabel.frame.size.width - 15, self.messageLabel.frame.size.height );
