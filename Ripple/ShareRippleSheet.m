...
+ (UIActivityViewController *)shareRippleSheet:(NSString *)string
{
    ...
    if (string)
    {
        ...
        shareText = [NSString stringWithFormat:@"Hey, I just downloaded the app Bellow and you should also try it out! Use my referral code \"%@\" to get 200 points when you sign in. Download it on the iOS or Google Play store, or at www.getBellow.com", [PFUser currentUser][@"username"]];
